...
3. Generate a story:
```bash
storygen-iter generate my-project --model xai/grok-2-1212
```
...
```bash
# Create a project
storygen-iter new my-story --pitch "A time traveler's dilemma"

# Generate with Grok
storygen-iter generate my-story --model xai/grok-2-1212 --words 3000

# Check status
storygen-iter status my-story
```
...
storygen-iter idea "A robot learns to paint" --model xai/grok-2-1212

# Generate full pipeline
storygen-iter generate temp-project --model xai/grok-2-1212 --words 2000 --pitch "A space adventure"
```
...
- Use `--words` to control story length and cost
...
- The project-based workflow helps manage costs by reusing generated content
...
storygen-iter generate my-project --model xai/grok-2-1212 --max-cost 1.00

# Check costs after generation
storygen-iter status my-project  # Shows cost breakdown
```
